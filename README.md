...
> [!NOTE]
> By default, `announcement.pre-refresh` is enabled (see the [configuration docs](docs/configuration.md)), which will display an update announcement 5 minutes before the Snap is updated. This will prolong the time the Snap is on hold during a refresh.
