...
dependencies_regexes = {
    ...
    "node": r"https://nodejs\.org/download/release/v([0-9\.]+)/node-v([0-9\.]+)-linux-x64\.tar\.gz",
    "node_arm64": r"https://nodejs\.org/download/release/v([0-9\.]+)/node-v([0-9\.]+)-linux-arm64\.tar\.gz",
    "pgbouncer": r"https://www.pgbouncer.org/downloads/files/[0-9\.]+/pgbouncer-([0-9\.]+).tar.gz",
